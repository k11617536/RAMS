          ...
          <form action="insert.php" method="post" role="form" class="php-email-form">
            <div class="form-row">
              ...
              <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="umakid" class="form-control" id="idnumber" placeholder="ID Number" data-rule="minlen:4" data-msg="Please enter your Id Number" />
                            <div class="validate"></div><br>

                            <input type="text" name="fname" class="form-control"  placeholder="First Name" data-rule="minlen:2" data-msg="Please enter your Last Name" />
                            <div class="validate"></div> <br>

                          <input type="text" name="lname" class="form-control"  placeholder="Last Name" data-rule="minlen:2" data-msg="Please enter your First Name" />
                            <div class="validate"></div> <br>
                          

                          <input type="email" class="form-control" name="email"  placeholder="UMak Email" data-rule="email" data-msg="Please enter a valid email" />
                          <div class="validate"></div> <br>

                          <input type="text" name="connum" class="form-control"  placeholder="Contact Number" data-rule="minlen:4" data-msg="Please enter your correct contact number." />
                          <div class="validate"></div><br>
                       </div>
              ...
              <!-- Dropdown -->
                          ...
                          <select required id="college"  class="form-control" name="college"  onchange="random_function()">
                            <option value="" disabled selected hidden>Choose College Department</option>
                            <option>	CCS	</option>
                            <option>	CBFS	</option>
                            <option>	CAL	</option>
                            <option>	CCSCE	</option>
                          ...
                          <select required id="output"  class="form-control"   name="program"  >
                            ...
                            <!-- CONCENRS -->
                             ...
                             <select required id="concern" class="form-control" name="concern" onchange="concern_function()">
